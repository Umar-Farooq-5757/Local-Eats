  ...
  return createPortal(
    ...
    >
      <div
        ...
        className={`h-[700px] w-[550px] py-5 px-5 absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 overflow-hidden bg-white transition-all border border-gray-100 text-sm shadow-md rounded-md`}
      >
<form 
        onSubmit={handleSubmit}
        className="w-full max-w-2xl mx-auto bg-white p-6 sm:p-8 rounded-lg shadow-xl space-y-6"
      >
        ...
        <div>
          ...
          {imagePreview ? (
            ...
            <div
              ...
              onDrop={handleDrop}
              className={`mt-2 flex justify-center px-6 pt-5 pb-6 border-2 ${isDragging ? 'border-blue-500 bg-blue-50' : 'border-gray-300'} border-dashed rounded-md cursor-pointer transition-colors duration-200 ease-in-out hover:border-blue-400`}
            >
        ...
        <div>
          <button
            ...
            disabled={!formData.title} // Example: disable if title is missing
          >
            Submit
          </button>
        </div>
